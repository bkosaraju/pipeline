...
import org.jdbi.v3.core.mapper.{CaseStrategy, MapMapper, MapMappers}
import org.jdbi.v3.postgres.PostgresPlugin

class DbConnection extends Session with Exceptions {

  def getConnection(params: Map[String,String]): Jdbi = {
    val jdbcURL =
      try {
...
object DbConnection {
  def apply(config: Map[String,String]): Jdbi = {
